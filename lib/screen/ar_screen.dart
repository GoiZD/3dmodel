...
class _ARScreenState extends State<WatchARScreen> {
  ...
  Future<void> _takePhoto(BuildContext context) async {
    try {
      ...
      // Save the picture to the document directory
      final String filePath = '$appDocPath/${DateTime.now().millisecondsSinceEpoch}.png';
